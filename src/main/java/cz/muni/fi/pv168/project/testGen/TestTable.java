...
public class TestTable {
    ...
    private static final List<Recipe> tableOne = List.of(
            new Recipe("guid1", "vomáčka", PRILOHA, LocalTime.parse("00:10"),4, instructionsTemplate),
            new Recipe("guid2", "polívka", HLAVNI_JIDLO, LocalTime.parse("02:00"),20, instructionsTemplate),
            new Recipe("guid3", "chleba", PRILOHA, LocalTime.parse("00:30"),6, instructionsTemplate),
            new Recipe("guid4", "maso", HLAVNI_JIDLO, LocalTime.parse("00:20"),4, instructionsTemplate),
            new Recipe("guid5", "dort", NONE, LocalTime.parse("01:00"),8, instructionsTemplate),
            new Recipe("guid6", "nevim", NONE, LocalTime.parse("23:59"),99, instructionsTemplate));
