 ...
 */
public class UnittSqlRepository implements Repository<Recipe> {
     ...
     *
     * @param unitDao The data access object for RecipeEntity.
     * @param unitMapper The entity mapper to map RecipeEntity to Recipe.
     */
    public UnittSqlRepository(
